                                ...
                                <div class="mb-0 pt-3 border-top">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('specific_dates') is-invalid @enderror"
                                            ...
                                            value="{{ is_array(old('specific_dates', $event->specific_dates)) ? implode(', ', old('specific_dates', $event->specific_dates)) : old('specific_dates', $event->specific_dates) }}">
                                    </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-12">
                                <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror"
                                    rows="10" placeholder="Enter event description">{{ $event->description }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-12">
                                <select name="always_show" id="always_show"
                                    ...
                                    <option value="0" {{ old('always_show', $event->always_show) == 0 ? 'selected' : '' }}>No (Follow Date Constraints)</option>
                                    <option value="1" {{ old('always_show', $event->always_show) == 1 ? 'selected' : '' }}>Yes (Always Show on Frontend)</option>
                                </select>
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-12">
                                <select name="is_active" id="is_active"
                                    ...
                                    <option value="0" {{ $event->is_active == 0 ? 'selected' : '' }}>Not Active</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
