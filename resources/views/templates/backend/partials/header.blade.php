                                                        ...
                                                        <a href="https://bootstrapdemos.wrappixel.com/materialM/dist/default-sidebar/app-contact.html"
                                                            ...
                                                            <div
                                                                ...
                                                                <img src="https://bootstrapdemos.wrappixel.com/materialM/dist/assets/images/svgs/icon-dd-lifebuoy.svg"
                                                                    alt="MaterialM-img" class="img-fluid"
                                                                    width="24" height="24" />
                                                            </div>
                                                            <div class="d-inline-block">
                                        ...
                                        <div class="row align-items-center py-3">
                                            <div class="col-8">
                                                <a class="fw-semibold text-dark d-flex align-items-center lh-1 bg-hover-primary"
                                                    href="https://bootstrapdemos.wrappixel.com/materialM/dist/default-sidebar/page-faq.html">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item nav-icon-hover d-none d-lg-block dropdown">
                    <div class="hover-dd">
                        ...
                        <div class="dropdown-menu dropdown-menu-nav  dropdown-menu-animate-up"
                            aria-labelledby="drop2">
                            <div class="row">
                                <div class="col-8">
                                    <div class="ps-3 pt-3">
                                                ...
                                                <div class="col-6">
                                                    <div class="position-relative">
                                                        ...
                                                        <a href="https://bootstrapdemos.wrappixel.com/materialM/dist/default-sidebar/app-contact2.html"
                                                            ...
                                                            <div class="d-inline-block">
                                                                <h6 class="mb-1">Contact Application
                                                                </h6>
                                                                <span class="fs-2 d-block text-muted">2
                                                                    Unsaved Contacts</span>
                                                            </div>
