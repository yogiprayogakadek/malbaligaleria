...
@section('page-link', route('admin.announcement.index'))
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        ...
                        <a href="{{ route('admin.announcement.create') }}" class="btn btn-primary"><i class="ti ti-plus me-1"></i> Add
                            Announcement</a>
                    </div>
                </div>
                <div class="card-body">
        ...
        $(document).ready(function() {
            ...
            $('#delete_selected').click(function() {
                ...
                Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete ' + ids.length + ' announcements!'
                }).then((result) => {
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.announcement.destroySelected') }}",
                            type: 'POST',
                            data: {
                                ids: ids,
                                _token: '{{ csrf_token() }}'
            ...
            $('body').on('click', '.btn-delete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        let url = "{{ route('admin.announcement.destroy', ':id') }}";
