...
@section('page-title', 'Edit Event Photo - ' . $eventPhoto->event->name)
@section('page-link', route('admin.event.photo.edit', $eventPhoto->id))
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('admin.event.photo.update', $eventPhoto->event_id) }}" method="POST"
