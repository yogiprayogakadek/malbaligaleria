    ...
    <style>
        ...
        *::-webkit-scrollbar {
        ...
        .dark-mode-toggle {
            ...
            right: 2rem;
            z-index: 101;
            background: rgba(95, 207, 218, 0.25);
            border: 1px solid rgba(95, 207, 218, 0.3);
            border-radius: 50%;
            width: 3.75rem;
            height: 3.75rem;
            padding: 0;
        ...
        .dark-mode-toggle:hover {
            background: rgba(77, 184, 195, 0.35);
            transform: scale(1.15) rotate(15deg);
            box-shadow: 0 15px 50px rgba(95, 207, 218, 0.4);
        }
        ...
        .tenant-info h1 {
            ...
            font-weight: 600;
            margin-bottom: 1rem;
            background: linear-gradient(135deg, #1e293b 0%, #5fcfda 100%);
        ...
        .action-btn.primary {
            ...
            color: white;
            box-shadow: 0 10px 30px rgba(95, 207, 218, 0.3);
        }
        ...
        .action-btn.primary:hover {
            ...
            box-shadow: 0 15px 40px rgba(95, 207, 218, 0.4);
        }
        ...
        .hover-glow:hover {
            box-shadow: 0 0 25px rgba(95, 207, 218, 0.4);
        }
        ...
        .similar-tenant-card:hover::before {
            background: linear-gradient(to bottom, rgba(95, 207, 218, 0.25) 60%, rgba(0, 0, 0, 0.85));
        }

        .similar-tenant-card:hover {
            transform: translateY(-10px) scale(1.03);
            box-shadow: 0 25px 60px rgba(0, 0, 0, 0.25);
            border-color: rgba(95, 207, 218, 0.3);
        }
        ...
        footer::before {
            ...
            right: 0;
            bottom: 0;
            background: url('data:image/svg+xml,<svg width="120" height="120" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="120" fill="none" stroke="rgba(95,207,218,0.05)" stroke-width="1"/><circle cx="60" cy="60" r="40" fill="none" stroke="rgba(95,207,218,0.03)" stroke-width="1"/><path d="M20,20 Q60,5 100,20 T180,60" fill="none" stroke="rgba(95,207,218,0.02)" stroke-width="1"/></svg>');
            opacity: 0.3;
        }
